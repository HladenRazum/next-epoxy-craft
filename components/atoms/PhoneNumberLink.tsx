...
export default function PhoneNumberLink({ number = '+359 8888 88888', text = 'За запитвания: ' }: PhoheNumberLinkProps) {
   return <a href={`tel:${number}`} className="flex items-center gap-3">
